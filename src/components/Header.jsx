...
export function Header() {
    ...
    return (
        <header className='min-w-full py-5 flex items-center justify-between'>
            <h1 className=" font-bold text-2xl ">CEMAST</h1>
            
            {
                !screen ? (
                    <button 
                        className="text-white p-2 rounded-full bg-gray-100 flex gap-3 items-center justify-center hover:brightness-110 transition-colors duration-500"
                        onClick={toggle}
                    >
                    ...
                    <>
                        <nav className="flex gap-4 md:gap-6 items-center justify-center text-zinc-400 font-bold text-xs md:text-sm">
